             ...
             <div align="center" class="col-sm-12">
 		            ...
 		            <form id="search_form" method="GET" action="{{ action('QAController@search_index') }}">
 		            		...
 		            		<div class="row">
		                      ...
		                      <p style="color: black;font-size: 18px;">The search will find entries whose tag/title/topic/author name will match your search term exactly. You can always disregard the suggestions that will be shown to you and search entries using a word/string of words.</p>
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="tabs-warp question-tab">
		            <ul class="tabs">
		                <li class="tab"><a href="#" class="current">Post(s)</a></li>
		                <li style='display: none;' class="tab"><a href="#">Most Responses</a></li>
...
<!-- comment part -->	
								...
								@if(($search_cat == "Word") || ($search_cat =="Words"))
