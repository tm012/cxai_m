...
$triggers_temp =  DB::table('triggers')->where('trigger_id', '>', 0)->where('trigger_belong_to', '=', 'qus')->where('trigger_header', '!=', 'Custom Topics-Comments')->orWhere('trigger_belong_to', '=', 'all')->get();
...
@if($reference_url == "")
	<input type="hidden" id="reference_url_passed" name="reference_url_passed"  />
@else
	<input type="hidden" id="reference_url_passed" name="reference_url_passed" value="{{$reference_url}}" />
@endif
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="page-content ask-question">
					<div class="boxedtitle page-title"><h2>New Post</h2></div>
					
					<p>Your post might relate to any of these possibilities.  Before typing your post below, check all of these that you think apply. </p>
						 ...
						 <form id="form-id" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ action('QAController@add_new_query') }}">
							...
							<div class="form-inputs clearfix">
								...
								<p style="margin-bottom: 0px!important">
								  ...
								  <div class="row">
								    <p>You can add custom topics. After writing a topic name click the 'ENTER' button.</p>
								     <div class="col-sm-12">
								     		<input type="text" class="input" name="custom_topics" id="custom_topics"  data-role="tagsinput">
								     </div>
								     <br>
								...
								<p>
									<label style="font-size: 18px!important;" class="required"> Give Your Post a Title<span>*</span></label>
									<input maxlength="180" type="text" id="question-title" name="post_title" >
									<span class="form-description">Please choose an appropriate title for the post to reply it even easier.</span>
								</p>
								...
								<div id="form-textarea">
								  ...
								  <div class="row">
								  	<div class="col-sm-3">
								  		<label style="font-size: 18px!important;" class="required">Keyword(s)/Tag(s)<span style="font-size: 12px;color: grey;">*</span></label>

								  	</div>
								    
								     <div class="col-sm-9">
								     		<input type="text" class="input" name="question_tags1" id="question_tags1"  data-role="tagsinput">

<span style="font-size: 12px;opacity: 0.4;color: black;" onMouseOver="this.style.color='#000'"
   onMouseOut="this.style.color='#000'" class="form-description">Please choose few suitable keywords Ex : <span class="color">blur , broken, etc.</span> to describe your post. After writing/selecting a keyword, click 'ENTER' button. You can add mutiple keywords.</span>
								...
								<p style="display: none;">
									...
									<span style="color:black;"class="form-description">Please choose few suitable keywords Ex : <span class="color">blur , broken, etc.</span> to describe your comment. After writing/selecting a keyword, click 'ENTER' button. You can add mutiple keywords.</span>
								</p>
								<p style="display: none;" >
							...
							<p style="display: none;">
								...
								<span class="form-description">You can add a URL here, it will be a reference for this post.</span>
								  ...
								  <div class="row">
								  	<div class="col-sm-2">
								  		<label style="font-size: 18px!important;" class="required">Reference(s)<span style="font-size: 12px;color: grey;">*</span></label>

								  	</div>
								    
								     <div class="col-sm-10">
								     		<input type="text" class="input" name="reference_list" id="reference_list"  data-role="tagsinput">

<span style="color:black;font-size: 12px;opacity: 0.4" class="form-description">You can add URLs here, these will be the references for this post. The first URL will be count as the main reference URL for this post. After writing a URL, click the 'ENTER' button.</span>
				        	...
				        	@if(Auth::check())
				        		...
				        		<p class="form-submit">
									<input type="button" id="publish-question" value="Publish Your Post" class="button color small submit">
								</p>
				        	@else
...
var tag_array;
var custom_topics_array;
$(function() {
	
	$("#posted_unix_time").val(get_date_time());

	reference_url_passed = $('#reference_url_passed').val();
	//alert(reference_url_passed);
	if(reference_url_passed == ""){

	}else{
		$('#reference_list').val(reference_url_passed);
	}

	//tag_array  = ["Afghanistan-Tag","Albania","Algeria","Andorra","Angola","Anguilla","Antigua & Barbuda"];

	 get_question_tags1();
	 get_custom_topics_array();
	
	//$("input:text").val("Glenn Quagmire");
 });

 function get_custom_topics_array(){
             ...
             // console.log(search_type);
              ...
              var productNames = new Array();
                ...
                $.each( jsonData, function ( index, product )
                {
                  ...
                  if((product.trigger!="What does it achieve?") && (product.trigger!="What can't it do?") && (product.trigger!="Why did it do that?") && (product.trigger!="Why didn't it do x?") && (product.trigger!="Here's something that surprised me.")&& (product.trigger!="Here's a trick I discovered.")&& (product.trigger!="How can I help it do better?")&& (product.trigger!="What do I have to look out for?")&& (product.trigger!="What do I do if it gets something wrong?")&&(product.trigger!="How can it fool me?")&&(product.trigger!="What do I do if I do not trust what it did?")){
                ...
                custom_topics_array = productNames;
