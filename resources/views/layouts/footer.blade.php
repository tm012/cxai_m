	<div style="display: none;" id="break_footer">
		<br>
	</div>
...
@endphp
	...
	<footer id="footer-bottom">
		<section class="container">
			...
			<div class="copyrights f_left">© {{$year}} <a target='_blank' href="https://www.mtu.edu">MTU</a>. All rights reserved.</div>
			<div style="display: none;" class="social_icons f_right">
				<ul>
    ...
    $(function() {
        ...
        if(current_page == "ask_query"){

        	document.getElementById("break_footer").style.display = "block";

        }else{

        	//document.getElementById("break_footer").style.display = "none";
        }
